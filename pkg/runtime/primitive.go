...
type PrimitiveType[P Proxy] interface {
	Client(client Client) (PrimitiveClient[P], bool)
}

// NewPrimitiveType creates a new type for the given primitive type
func NewPrimitiveType[P Proxy](getter func(client Client) (PrimitiveClient[P], bool)) PrimitiveType[P] {
...
type primitiveType[P Proxy] struct {
	getter func(client Client) (PrimitiveClient[P], bool)
}

func (t *primitiveType[P]) Client(client Client) (PrimitiveClient[P], bool) {
