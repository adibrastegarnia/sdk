...
// source: atomix/list/v1/manager.proto
...
func (*CreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafa4e3f77773e71, []int{0}
}
...
func (*CreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafa4e3f77773e71, []int{1}
}
...
func (*CloseRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafa4e3f77773e71, []int{2}
}
...
func (*CloseResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafa4e3f77773e71, []int{3}
}
...
func init() { proto.RegisterFile("atomix/list/v1/manager.proto", fileDescriptor_cafa4e3f77773e71) }

var fileDescriptor_cafa4e3f77773e71 = []byte{
	// 371 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0x2c, 0xc9, 0xcf,
	0xcd, 0xac, 0xd0, 0xcf, 0xc9, 0x2c, 0x2e, 0xd1, 0x2f, 0x33, 0xd4, 0xcf, 0x4d, 0xcc, 0x4b, 0x4c,
	...
	0x6a, 0xfb, 0xd6, 0x68, 0x1f, 0x23, 0x17, 0xb7, 0x4f, 0x66, 0x71, 0x89, 0x2f, 0x24, 0xe1, 0x09,
	...
	0x49, 0x6c, 0xe0, 0xf4, 0x6b, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xb4, 0x04, 0x14, 0xef, 0x64,
	0x03, 0x00, 0x00,
}
...
func (c *listManagerClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	out := new(CreateResponse)
	err := c.cc.Invoke(ctx, "/atomix.list.v1.ListManager/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *listManagerClient) Close(ctx context.Context, in *CloseRequest, opts ...grpc.CallOption) (*CloseResponse, error) {
	out := new(CloseResponse)
	err := c.cc.Invoke(ctx, "/atomix.list.v1.ListManager/Close", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedListManagerServer) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (*UnimplementedListManagerServer) Close(ctx context.Context, req *CloseRequest) (*CloseResponse, error) {
...
func _ListManager_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ListManagerServer).Create(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.list.v1.ListManager/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListManagerServer).Create(ctx, req.(*CreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ListManager_Close_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CloseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ListManagerServer).Close(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.list.v1.ListManager/Close",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListManagerServer).Close(ctx, req.(*CloseRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _ListManager_serviceDesc = grpc.ServiceDesc{
	ServiceName: "atomix.list.v1.ListManager",
	HandlerType: (*ListManagerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Create",
			Handler:    _ListManager_Create_Handler,
		},
		{
			MethodName: "Close",
			Handler:    _ListManager_Close_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "atomix/list/v1/manager.proto",
}
