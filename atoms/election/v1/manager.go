...
func newLeaderElectionV1ManagerServer(proxies *atom.Service[LeaderElectionProxy]) electionv1.LeaderElectionManagerServer {
...
type leaderElectionV1ManagerServer struct {
	proxies *atom.Service[LeaderElectionProxy]
}
